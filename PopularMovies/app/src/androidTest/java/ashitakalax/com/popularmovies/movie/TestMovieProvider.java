...
public class TestMovieProvider extends AndroidTestCase {
    ...
    public void deleteAllRecordsFromProvider() {
        ...
        assertEquals("Error: Records not deleted from Tralier table during delete", 0, cursor.getCount());
        cursor.close();
    ...
    public void testGetType() {
        ...
        // vnd.android.cursor.dir/ashitakalax.com.popularmovies/movie
        assertEquals("Error: the MovieEntry CONTENT_URI should return MovieEntry.CONTENT_TYPE",
                MovieContract.MovieEntry.CONTENT_TYPE, type);

        String testMovieKeyId = "1234";
        // content://ashitakalax.com.popularmovies/reviews/1234
        type = mContext.getContentResolver().getType(MovieContract.ReviewEntry.buildMovieReview(testMovieKeyId));
        // vnd.android.cursor.item/ashitakalax.com.popularmovies/reviews/1234
        assertEquals("Error: the ReviewEntry CONTENT_URI with movieId should return ReviewEntry.CONTENT_ITEM_TYPE",
                MovieContract.ReviewEntry.CONTENT_ITEM_TYPE, type);

        // content://ashitakalax.com.popularmovies/trailers/1234
        type = mContext.getContentResolver().getType(MovieContract.TrailerEntry.buildMovieTrailer(testMovieKeyId));
        // vnd.android.cursor.item/ashitakalax.com.popularmovies/trailers/1234
        assertEquals("Error: the TrailerEntry CONTENT_URI with movieId should return TrailerEntry.CONTENT_ITEM_TYPE",
                MovieContract.TrailerEntry.CONTENT_ITEM_TYPE, type);

        // content://ashitakalax.com.popularmovies/reviews/
        type = mContext.getContentResolver().getType(MovieContract.ReviewEntry.CONTENT_URI);
        // vnd.android.cursor.dir/ashitakalax.com.popularmovies/reviews
        assertEquals("Error: the LocationEntry CONTENT_URI should return LocationEntry.CONTENT_TYPE",
                MovieContract.ReviewEntry.CONTENT_TYPE, type);

        // content://ashitakalax.com.popularmovies/trailers/
        type = mContext.getContentResolver().getType(MovieContract.TrailerEntry.CONTENT_URI);
        // vnd.android.cursor.dir/ashitakalax.com.popularmovies/trailers
        assertEquals("Error: the LocationEntry CONTENT_URI should return LocationEntry.CONTENT_TYPE",
    ...
    public void testBasicTrailerQuery() {
        ...
        //now insert the reviews and the trailers
        ContentValues testTrailerValues = TestUtilities.createAwesomeTrailer();
    ...
    public void testBasicReviewQuery() {
        ...
        //now insert the reviews and the trailers
        ContentValues testReviewValues = TestUtilities.createAwesomeReviews();
        long reviewRowId = TestUtilities.insertReviewsValues(mContext);
...
//    }
    ...
    public void testUpdateLocation() {
        ...
        ContentValues values = TestUtilities.createAwesomeMovieValues();
        ...
        //id for the movie
        updatedValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_ID, TestUtilities.TEST_MOVIE_ID);
        //update the Movie value
        //weatherValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_TITLE, "AWESOME TO THE MAX");
        updatedValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_TITLE, "MAX AWESOME");
        ...
        int count = mContext.getContentResolver().update(
                ...
                new String[] { Long.toString(TestUtilities.TEST_MOVIE_ID)});
        ...
        Cursor cursor = mContext.getContentResolver().query(
                MovieContract.MovieEntry.CONTENT_URI,
                null,   // projection
                MovieContract.MovieEntry.COLUMN_MOVIE_ID + " = " + TestUtilities.TEST_MOVIE_ID,
