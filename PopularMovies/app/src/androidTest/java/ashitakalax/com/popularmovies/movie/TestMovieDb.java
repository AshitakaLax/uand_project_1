...
public class TestMovieDb extends AndroidTestCase{
    ...
    public  static final  String TEST_LOG_TAG = TestMovieDb.class.getSimpleName();
    ...
    public void testCreateDb() throws Exception {
        ...
        assertTrue("Error: Your database was created without both the Movie entry, Review entry, and Trailer entry tables",
